...
const COLLECTIONS = [
  ...
  {
    href: "/altin/halkalar?tur=alyans",
    label: "Alyans",
    subtitle: "Ebedi Bağın Sembolü",
    image: "/images/web/9 (2).png",
    span: "col-span-1",
    aspect: "aspect-[3/4]",
  },
  {
    href: "/altin/bileklikler?tur=kelepce",
    label: "Kelepçe",
    subtitle: "Güçlü & İddialı",
    image: "/images/web/8 (1).png",
    span: "col-span-1",
    aspect: "aspect-[3/4]",
  },
  {
    href: "/altin/kolyeler?tur=gerdanlik",
    label: "Gerdanlık",
    subtitle: "Zarafetin Doruğu",
  ...
  {
    href: "/altin/kupeler?tur=piercing",
    label: "Piercing",
...
export default function AltinLandingClient() {
  return (
    <PageWrapper>
      <Navbar />
      <main className="min-h-screen bg-[#FAF9F6]">
        ...
        <section className="relative w-full h-[50vh] md:h-[55vh] overflow-hidden bg-onyx">
          ...
          <div className="absolute inset-0 flex flex-col justify-end px-8 pb-12 lg:px-20 lg:pb-16">
            ...
            >
              Saf altının zarafetiyle tasarlanan koleksiyonlarımızı keşfedin.
            </motion.p>
          </div>
        </section>
